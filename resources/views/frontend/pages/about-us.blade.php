...
@section('title','ExamBakeli || About Us')
				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="blog-single.html">Bayo Holding Equipements représente et distribue <br> des types d’outillages professionnels d’excellente <br>qualité, machines–outils, matériel de jardinage…</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="about-content">
							...
							@endphp
							<h3>Faites votre commande en nous contactant <span> BAYO HOLDING</span></h3>
							<p>@foreach($settings as $data) {{$data->description}} @endforeach</p>
							{{-- <div class="button">
								<a href="{{route('blog')}}" class="btn">Our Blog</a>
								<a href="{{route('contact')}}" class="btn primary">Tickets</a>
							</div> --}}
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						<img src="{{asset('./images/image13.png')}}"/>
				...
				<div class="col-lg-3 col-md-6 col-12">
					<!-- Start Single Service -->
					<div class="single-service">
						<img src="{{asset('./images/image14.png')}}"/>
				...
				<div class="col-lg-3 col-md-6 col-12">
					<!-- Start Single Service -->
					<div class="single-service">
                        <img src="{{asset('./images/image15.png')}}"/>
				...
				<div class="col-lg-3 col-md-6 col-12">
					<!-- Start Single Service -->
					<div class="single-service">
						<img src="{{asset('./images/image16.png')}}"/>
